...
const d = JSON.parse(document.getElementById('rad-chart-data').textContent);
  ...
  new Chart(document.getElementById('radMainChart'), {
    type: 'bar',
    data: {
      labels: ['مطلوبة', 'قيد العمل', 'مكتملة', 'أسبوعي', 'شهري'],
      datasets: [{
        label: 'الطلبات',
        data: d.mainData,
        backgroundColor: ['#0d6efd', '#ffc107', '#198754', '#6f42c1', '#0dcaf0']
      }]
    },
  ...
  new Chart(document.getElementById('equipmentChart'), {
    ...
    data: {
      labels: ['تعمل', 'صيانة'],
      datasets: [{ data: d.equipment, backgroundColor: ['#198754', '#ffc107'] }]
    },
