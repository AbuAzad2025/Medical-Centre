...
def main():
    ...
    with app.app_context():
        try:
            ...
            print(f"   - التوصيات الذكية: {AIRecommendation.query.count()}")
            print(f"   - إعدادات النظام: {SystemConfig.query.count()}")
