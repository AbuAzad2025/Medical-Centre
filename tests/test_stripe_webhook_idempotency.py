...
class TestStripeWebhookIdempotency:
    ...
    def test_ingest_webhook_creates_event_record(self, app, mock_payload, mock_stripe_event):
        with patch.object(StripeSubscriptionService, 'verify_signature', return_value=mock_stripe_event):
    ...
    def test_duplicate_event_id_returns_already_processed(self, app, mock_payload, mock_stripe_event):
        with patch.object(StripeSubscriptionService, 'verify_signature', return_value=mock_stripe_event):
            with patch.object(StripeSubscriptionService, '_tenant_from_event', return_value=None):
    ...
    def test_concurrent_duplicate_webhooks_return_single_record_mocked(self, app):
        ...
        try:
            ...
            with patch.object(StripeSubscriptionService, '_check_idempotency', return_value=mock_record):
