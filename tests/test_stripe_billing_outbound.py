...
class TestStripeBillingOutbound:
    def test_ensure_customer_creates_stripe_customer(
    ...
    def test_cancel_subscription_updates_local_entitlements(
        self, app, stripe_api_key, billing_tenant, monkeypatch
    ):
        tenant, _version = billing_tenant
    ...
    def test_cancel_immediate_cancels_tenant(
        self, app, stripe_api_key, billing_tenant, monkeypatch
    ):
        tenant, _version = billing_tenant
    ...
    def test_billing_portal_session_returns_url(
        self, app, stripe_api_key, billing_tenant, monkeypatch
    ):
        tenant, _version = billing_tenant
        monkeypatch.setattr(
    ...
    def test_checkout_missing_package_version_raises(
        self, app, stripe_api_key, billing_tenant, monkeypatch
    ):
        tenant, _version = billing_tenant
        monkeypatch.setattr(
