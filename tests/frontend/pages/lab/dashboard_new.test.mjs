...
describe('lab/dashboard_new.js', () => {
  test('loads without critical errors', async () => {
    await loadScript('static/js/pages/lab/dashboard_new.js');
  });
});
