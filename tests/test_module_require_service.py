...
GATED_METHODS = [
    ...
    ("pharmacy", RX, "create_prescription", (1, 1, "outpatient", [])),
    ("pharmacy", RX, "get_active_prescriptions", (1,)),
    ...
    ("emergency", ER, "notify_staff", (types.SimpleNamespace(id=1, chief_complaint="x", priority="HIGH"), "new_case")),
