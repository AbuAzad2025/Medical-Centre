...
MODULE_ROUTE_MAP: dict[str, dict] = {
    'reception': {
        'blueprints': ['reception_bp', 'reception_currency_bp'],
        'prefixes': ['/reception'],
    },
    'doctor': {
        'blueprints': [
    ...
    'nursing': {
        'blueprints': ['nurse_bp', 'emar_bp', 'bed_bp', 'or_bp', 'nursing_assessment_bp'],
        'prefixes': ['/nurse', '/emar', '/bed', '/or', '/nursing-assessment'],
    },
    'billing': {
        'blueprints': ['finance_bp', 'accountant_bp', 'payment_bp'],
        'prefixes': ['/finance', '/accountant', '/payment'],
    },
