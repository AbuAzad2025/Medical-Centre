...
WIDGETS: dict[str, WidgetMeta] = {
    'queue_live': WidgetMeta(
        id='queue_live',
        title_ar='الطابور الآن',
        roles=('reception', 'manager'),
        modules=('reception',),
        size='md',
        priority=1,
        template='dashboards/widgets/_queue_live.html',
        data_endpoint='/api/dashboard/snapshot',
        icon='fa-list-ol',
        action_url='reception.queue_management',
        action_label='افتح الطابور',
    ),
    'visits_today': WidgetMeta(
        ...
        size='lg',
        priority=2,
        template='dashboards/widgets/_visits_today.html',
    ...
    'cash_summary': WidgetMeta(
        ...
        size='sm',
        priority=1,
        template='dashboards/widgets/_cash_summary.html',
        icon='fa-cash-register',
        action_url='reception.cash_register',
        action_label='الصندوق',
    ),
    'my_queue': WidgetMeta(
        id='my_queue',
        title_ar='طابوري',
        ...
        data_endpoint='/api/dashboard/snapshot',
        icon='fa-stethoscope',
        action_url='doctor.patient_queue',
        action_label='ابدأ الكشف',
    ),
    'patients_waiting': WidgetMeta(
        id='patients_waiting',
        title_ar='مرضى بالانتظار',
        roles=('doctor',),
        modules=('doctor',),
        size='sm',
        priority=1,
        template='dashboards/widgets/_patients_waiting.html',
        icon='fa-user-clock',
    ),
    'lab_pending': WidgetMeta(
        id='lab_pending',
        title_ar='طلبات المختبر',
        roles=('doctor', 'lab'),
        modules=('lab',),
        size='md',
        priority=2,
        template='dashboards/widgets/_lab_pending.html',
        icon='fa-flask',
        action_url='lab.worklist',
        action_label='قائمة العمل',
    ),
    'radiology_pending': WidgetMeta(
        id='radiology_pending',
        title_ar='طلبات الأشعة',
        roles=('doctor', 'radiology'),
        modules=('radiology',),
        size='md',
        priority=2,
        template='dashboards/widgets/_radiology_pending.html',
        icon='fa-x-ray',
    ),
    'worklist_urgent': WidgetMeta(
        ...
        size='md',
        priority=1,
        template='dashboards/widgets/_lab_worklist.html',
        icon='fa-vial',
        action_url='lab.worklist',
        action_label='قائمة العمل',
    ),
    'triage_board': WidgetMeta(
        id='triage_board',
        title_ar='الحالات النشطة',
        roles=('emergency',),
        modules=('emergency',),
        size='lg',
        priority=1,
        template='dashboards/widgets/_triage_board.html',
        icon='fa-ambulance',
        action_url='emergency.queue',
        action_label='حالات الطوارئ',
    ),
    'critical_count': WidgetMeta(
        ...
        size='sm',
        priority=1,
        template='dashboards/widgets/_critical_count.html',
        icon='fa-heart-pulse',
    ),
    'pending_payments': WidgetMeta(
        id='pending_payments',
        title_ar='مدفوعات معلقة',
        roles=('accountant',),
        modules=('billing',),
        size='md',
        priority=1,
    ...
    'nurse_assigned': WidgetMeta(
        ...
        size='lg',
        priority=1,
        template='dashboards/widgets/_nurse_assigned.html',
        icon='fa-user-nurse',
    ),
    'pharmacy_dispense': WidgetMeta(
        ...
        icon='fa-pills',
        action_url='medication.pos',
        action_label='نقطة البيع',
    ),
    'pharmacy_low_stock': WidgetMeta(
        ...
        action_url='medication.stock_alerts',
    ...
    'lab_recent': WidgetMeta(
        id='lab_recent',
        title_ar='آخر طلبات المختبر',
        roles=('lab', 'technician'),
        modules=('lab',),
        size='lg',
        priority=2,
        template='dashboards/widgets/_lab_recent.html',
        icon='fa-vial',
        action_url='lab.worklist',
        action_label='قائمة العمل',
    ),
    'emergency_waitlist': WidgetMeta(
        id='emergency_waitlist',
        title_ar='قائمة الانتظار',
        roles=('emergency',),
        modules=('emergency',),
        size='lg',
        priority=2,
        template='dashboards/widgets/_emergency_waitlist.html',
        icon='fa-list',
        action_url='emergency.queue',
        action_label='حالات الطوارئ',
    ),
