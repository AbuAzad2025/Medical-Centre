...
class WhatsAppClient:
    ...
    def __init__(self, api_token: str | None = None, phone_number_id: str | None = None):
    ...
    def send_text(self, to: str, body: str, preview_url: bool = False) -> dict:
        ...
        resp = requests.post(
            self._url('messages'), headers=self._headers(), json=payload, timeout=30
        )
        resp.raise_for_status()
        return resp.json()

    def send_template(
        self, to: str, template_name: str, language_code: str = 'ar', components: list | None = None
    ) -> dict:
    ...
    def send_document(self, to: str, document_url: str, caption: str | None = None) -> dict:
        payload = {
            'messaging_product': 'whatsapp',
            'to': to,
            'type': 'document',
