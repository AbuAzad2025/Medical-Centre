...
class ZPLLabelPrinter:
    ...
    def _build_label(self, lines: list[str], barcode: str | None = None) -> str:
    ...
    def print_medication_label(
        self, medication_name: str, batch: str, expiry: str, barcode: str | None = None
    ) -> str:
        zpl = self._build_label(
            [medication_name, f'Batch: {batch}', f'Exp: {expiry}'], barcode=barcode
        )
