...
class SystemConfig(TenantMixin, db.Model):
    ...
    )  # general, security, notification, backup, system
    ...
    creator = db.relationship(
        'User', foreign_keys=[created_by], back_populates='created_system_configs', lazy='selectin'
    )
    updater = db.relationship(
        'User', foreign_keys=[updated_by], back_populates='updated_system_configs', lazy='selectin'
    )
