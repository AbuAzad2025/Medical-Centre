...
class SurgerySchedule(db.Model):
    ...
    assistant_surgeon_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=True)
    ...
    admission = db.relationship('Admission', backref='surgeries')
    visit = db.relationship('Visit', backref='surgeries')
...
class SurgeryChecklist(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    surgery_schedule_id = db.Column(db.Integer, db.ForeignKey('surgery_schedules.id'), nullable=False)
    ...
    surgery = db.relationship('SurgerySchedule', backref='checklist')
