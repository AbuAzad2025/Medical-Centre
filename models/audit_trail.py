...
class AuditTrail(TenantMixin, db.Model):
    ...
    __table_args__ = (
        ...
        CheckConstraint("action IN ('create', 'update', 'delete', 'view', 'login', 'logout', 'export', 'import', 'backup', 'restore', 'security', 'login_failed', 'login_blocked', 'force_logout', 'permission_denied', 'unauthorized_access', 'APPROVE', 'REJECT', 'IMPERSONATE')", name='chk_action'),
