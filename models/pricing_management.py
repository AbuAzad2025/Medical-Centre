...
class PricingManagement(db.Model):
    ...
    insurance_price = db.Column(db.Float, nullable=True)
    private_price = db.Column(db.Float, nullable=True)
    ...
    def get_final_price(self, price_type='base'):
        ...
        elif self.tax_amount > 0:
            price = price + self.tax_amount
...
class PricingRule(db.Model):
    ...
    price_adjustment_value = db.Column(db.Float, nullable=False)
