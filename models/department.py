...
class Department(TenantMixin, db.Model):
    ...
    visits = db.relationship(
        'Visit', back_populates='department', lazy='selectin', passive_deletes=True
    )

    appointments = db.relationship(
        'Appointment', back_populates='department', lazy='selectin', passive_deletes=True
    )
    ...
    doctor_pricing = db.relationship('DoctorPricing', back_populates='department', lazy='selectin')
