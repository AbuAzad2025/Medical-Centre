...
class RefundRequest(TenantMixin, db.Model):
    ...
    payment_id = db.Column(
        db.Integer, db.ForeignKey('payments.id', ondelete='CASCADE'), nullable=False, index=True
    )
    ...
    requested_at = db.Column(db.DateTime, default=lambda: datetime.now(UTC), nullable=False)
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "status IN ('PENDING', 'APPROVED', 'REJECTED', 'EXECUTED')", name='chk_refund_status'
        ),
