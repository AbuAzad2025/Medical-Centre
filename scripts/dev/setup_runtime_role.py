...
"""
import os, sys, re, secrets, string, subprocess
...
if not os.path.isfile(PSQL):
    # Try fallback path
    for p in [r"C:\Program Files\PostgreSQL\17\bin\psql.exe",
...
print(f"  Granted USAGE on sequences")
...
print(f"  Granted SELECT on alembic_version")
