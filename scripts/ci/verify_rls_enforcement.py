...
def main() -> int:
    ...
    with admin.connect() as c:
        ...
        psql(
            c,
            f"CREATE ROLE {ROLE_NAME} WITH LOGIN PASSWORD 'test123' "
        ...
        psql(
            c, f'GRANT SELECT ON TABLE tenants, module_definitions, alembic_version TO {ROLE_NAME}'
        )
    ...
    try:
        ...
        with rls_engine.connect() as conn:
            ...
            print(
                f'OK  RLS filter active: patients count = {patients} '
