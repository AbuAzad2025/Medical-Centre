...
class DataRetentionService:
    ...
    DEFAULT_POLICIES: list[RetentionPolicy] = [
        RetentionPolicy(
            RetentionCategory.MEDICAL_RECORD,
            10,
            'default',
            'archive',
            True,
        ...
        RetentionPolicy(
            RetentionCategory.RADIOLOGY_RESULT,
            7,
            'default',
            'archive',
            True,
        ...
        RetentionPolicy(
            RetentionCategory.BILLING_RECORD,
            7,
            'default',
            'archive',
            True,
        ...
        RetentionPolicy(
            RetentionCategory.COMMUNICATION,
            1,
            'default',
            'anonymize',
            False,
    ...
    def calculate_retention_deadline(
        self, category: RetentionCategory, created_at: datetime
    ) -> datetime:
    ...
    def delete_expired_session_logs(
        self, tenant_id: int, dry_run: bool = True
    ) -> tuple[int, list[int]]:
        """
