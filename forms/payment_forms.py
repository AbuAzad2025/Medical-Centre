...
class PaymentSearchForm(FlaskForm):
    ...
    date_from = DateField('من تاريخ', validators=[Optional()], render_kw={'class': 'form-control'})

    date_to = DateField('إلى تاريخ', validators=[Optional()], render_kw={'class': 'form-control'})
