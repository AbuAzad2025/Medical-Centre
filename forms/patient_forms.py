...
class PatientRegistrationForm(FlaskForm):
    ...
    gender = SelectField(
        'الجنس', choices=[('male', 'ذكر'), ('female', 'أنثى')], validators=[DataRequired()]
    )
    ...
    emergency_contact_name = StringField(
        'اسم جهة الاتصال في الطوارئ', validators=[DataRequired(), Length(max=100)]
    )
    emergency_contact_phone = StringField(
        'رقم جهة الاتصال في الطوارئ', validators=[DataRequired(), Length(min=10, max=15)]
    )
    emergency_contact_relation = SelectField(
        'صلة القرابة',
        choices=[
            ('parent', 'والد/والدة'),
            ('spouse', 'زوج/زوجة'),
...
class PatientSearchForm(FlaskForm):
    ...
    gender = SelectField(
        'الجنس',
        choices=[('', 'جميع الأجناس'), ('male', 'ذكر'), ('female', 'أنثى')],
        validators=[Optional()],
    )
